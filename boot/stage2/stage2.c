...
__attribute__((section(".text.stage2"))) void stage2_boot(void) {
    ...
    IDT32ISRHandler isr_table[] = {
        ...
        {.type=IDT32_ISR_INTERRUPT, .handler = idt32_isr_32 },
        {.type=IDT32_ISR_INTERRUPT, .handler = idt32_isr_33 },
        {.type=IDT32_ISR_INTERRUPT, .handler = idt32_isr_34 },
        {.type=IDT32_ISR_INTERRUPT, .handler = idt32_isr_35 },
        {.type=IDT32_ISR_INTERRUPT, .handler = idt32_isr_36 },
        {.type=IDT32_ISR_INTERRUPT, .handler = idt32_isr_37 },
        {.type=IDT32_ISR_INTERRUPT, .handler = idt32_isr_38 },
        {.type=IDT32_ISR_INTERRUPT, .handler = idt32_isr_39 },
        {.type=IDT32_ISR_INTERRUPT, .handler = idt32_isr_40 },
        {.type=IDT32_ISR_INTERRUPT, .handler = idt32_isr_41 },
        {.type=IDT32_ISR_INTERRUPT, .handler = idt32_isr_42 },
        {.type=IDT32_ISR_INTERRUPT, .handler = idt32_isr_43 },
        {.type=IDT32_ISR_INTERRUPT, .handler = idt32_isr_44 },
        {.type=IDT32_ISR_INTERRUPT, .handler = idt32_isr_45 },
        {.type=IDT32_ISR_INTERRUPT, .handler = idt32_isr_46 },
        {.type=IDT32_ISR_INTERRUPT, .handler = idt32_isr_47 },
    };
